...
public class Supermarket {
    ...
    private static int productCount = 0; // for keep tarck of no. of product.
    private static double total_price = 0;  // making static because we are calculating sum of all the products and we can directly get it through class but making private so outside class we can not call it.
    ...
    public static Product[] getProductList() {
        Product[] productList = Arrays.copyOf(products, productCount);  // copying all the products upto the valid filed
        return productList;
    }
